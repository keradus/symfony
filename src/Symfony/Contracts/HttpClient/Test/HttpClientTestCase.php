...
abstract class HttpClientTestCase extends TestCase
{
    ...
    public function testThrowingBufferCallback(): void
    {
        ...
        $response = $client->request('GET', 'http://localhost:8057', ['buffer' => static function (): void {
    ...
    public function testRedirects(array $headers = []): void
    {
        $client = $this->getHttpClient(__FUNCTION__);
    ...
    public function testOnProgress(): void
    {
        ...
        $response = $client->request('POST', 'http://localhost:8057/post', [
            ...
            'body' => 'foo=0123456789',
            'on_progress' => static function (...$state) use (&$steps): void { $steps[] = $state; },
        ]);
    ...
    public function testOnProgressCancel(): void
    {
        ...
        $response = $client->request('GET', 'http://localhost:8057/timeout-body', [
            'on_progress' => static function ($dlNow): void {
                if (0 < $dlNow) {
    ...
    public function testIdnResolve(): void
    {
        $client = $this->getHttpClient(__FUNCTION__);
    ...
    public function testBindToPort(): void
    {
        $client = $this->getHttpClient(__FUNCTION__);
    ...
    public function testBindToPortV6(): void
    {
        TestHttpServer::start(-8087);
